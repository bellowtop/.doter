...
;; Package-Version: 20260710.1606
;; Package-Revision: d32469ec6529
  ...
  (quote
   (mapcar
    ...
    `(;; Standard font lock faces
      ...
      ;; howm
      (howm-menu-key-face (:foreground ,orange))
      (howm-mode-keyword-face (:foreground ,blue :inverse-video t))
      (howm-mode-ref-face (:inherit link))
      (howm-mode-title-face (:inherit default :weight bold))
      (howm-mode-wiki-face (:inherit link))
      (howm-reminder-deadline-face (:foreground ,red))
      (howm-reminder-defer-face (:foreground ,purple))
      (howm-reminder-done-face (:foreground ,comment))
      (howm-reminder-late-deadline-face (:inherit howm-reminder-deadline-face :inverse-video t))
      (howm-reminder-normal-face (:foreground ,blue))
      (howm-reminder-schedule-face (:foreground ,green))
      (howm-reminder-today-face (:foreground ,orange :inverse-video t))
      (howm-reminder-todo-face (:foreground ,yellow))
      (howm-reminder-tomorrow-face (:foreground ,yellow :inverse-video t))
      (howm-simulate-todo-mode-line-face (:foreground ,red :inverse-video t))
      (howm-view-empty-face (:foreground ,comment))
      (howm-view-hilit-face (:inherit match))
      (howm-view-name-face (:foreground ,aqua))
