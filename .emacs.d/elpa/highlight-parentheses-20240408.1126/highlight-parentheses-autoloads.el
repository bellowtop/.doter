...
"Toggle Highlight-Parentheses mode in many buffers.
Specifically, Highlight-Parentheses mode is enabled in all buffers
where `(lambda nil (highlight-parentheses-mode 1))' would do it.
